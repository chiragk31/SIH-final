...
import { LogOut, LayoutDashboard, Users, GraduationCap, Video, BookOpen } from 'lucide-react'; // Added BookOpen
...
export default function AdminLayout({ children }: AdminLayoutProps) {
    ...
    const navigation = [
        ...
        { name: 'Courses', href: '/admin/courses', icon: BookOpen }, // Changed to BookOpen
    ];
