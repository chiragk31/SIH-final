...
export const Header = ({ isAuthenticated = false, userType, userName = "User", onLogout }: HeaderProps) => {
  ...
  type Role = 'student' | 'teacher' | 'public';
  ...
  // Production-ready reusable role-based menu configuration
  const NAV_ITEMS: NavItem[] = [
    // Public routes
    { path: '/landingpage', label: t('common.home'), roles: ['public'] },
    { path: '/login', label: t('common.studentLogin'), roles: ['public'] },
    { path: '/teacherlogin', label: t('common.teacherLogin'), roles: ['public'] },

    // Student routes
    { path: '/homepage', label: t('common.browseCourses'), roles: ['student'] },
    { path: '/enrolled', label: t('common.myCourses'), roles: ['student'] },
    { path: '/image-translation', label: 'Image Translation', roles: ['student'] },
    { path: '/documents', label: 'Documents', roles: ['student'] },
    { path: '/community', label: t('common.community'), roles: ['student'] },
    { path: '/rewards', label: t('common.rewards'), roles: ['student'] },
    { path: '/roadmap', label: t('common.aiRoadmap'), roles: ['student'] },
    { path: '/podcast', label: t('common.podcast'), roles: ['student'] },

    // Teacher routes
    { path: '/teacher/dashboard', label: t('common.dashboard'), roles: ['teacher'] },
    { path: '/teacher/courses', label: t('common.myCourses'), roles: ['teacher'] },
    { path: '/teacher/upload', label: t('common.uploadContent'), roles: ['teacher'] },
    { path: '/teacher/quizzes', label: t('common.createQuiz'), roles: ['teacher'] },
    { path: '/teacher/doubts', label: t('common.studentDoubts'), roles: ['teacher'] },
    
    // Example of a shared route:
    // { path: '/common-feature', label: 'Common Feature', roles: ['student', 'teacher'] },
  ];

  const getNavLinks = () => {
    if (!effectiveIsAuthenticated) {
      return NAV_ITEMS.filter(item => item.roles.includes('public'));
    }

    const currentRole: Role = effectiveUserType === 'teacher' ? 'teacher' : 'student';
